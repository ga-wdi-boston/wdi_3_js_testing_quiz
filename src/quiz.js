...
//
// assertion = made up of an expression & a matcher, an assertion is also known as an expressions and is the main component of testing code.
//
// black-box testing = when we know the input and what is supposed to be the output, but do not really care what the "meat" of the function is made up of.
